...
Source: [`packages/api/workspace-files/src/index.ts:63`](../packages/api/workspace-files/src/index.ts)
...
Requires: `agents` · `attachments` · `chatChannels` · `fs` · `sandboxPolicy` · `settings`
...
Requires: `agents` · `agentDefaultModel` · `agentPresets` · `llm` · `permissionPresets`
...
Source: [`packages/tuitui/tuitui/src/index.ts:61`](../packages/tuitui/tuitui/src/index.ts)
