...
| [`client/ui-sidebar-textpreview`](../../packages/client/ui-sidebar-textpreview/README.md), [`client/ui-sidebar-files`](../../packages/client/ui-sidebar-files/README.md), [`client/ui-sidebar-tasks`](../../packages/client/ui-sidebar-tasks/README.md), [`client/ui-sidebar-agents`](../../packages/client/ui-sidebar-agents/README.md), [`client/ui-sidebar-git`](../../packages/client/ui-sidebar-git/README.md) | The shipped `text`, `files`, `tasks`, `agents`, and `git` types |
