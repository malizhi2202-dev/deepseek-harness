...
| [`git/`](git/README.zh.md) | 只读仓库观察：seam、本地 provider、其供血的 Web git 面板 |
...
| [`resource/`](resource/README.zh.md) | 远程 resource 系列：`ctx.sources` seam、wiki/代码/数据库提供方、面向模型的 source 工具 |
