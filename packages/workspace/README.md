...
| [`workspace-automation`](workspace-automation/README.md) | Runs the per-workspace alignment timer and the automatic turn-boundary commit, with no path to a remote write | `ctx.workspaceAutomation` |
...
- [Workspace subsystem](../../docs/subsystems/workspace.md) — the authoritative feature contract for projects, their sessions, and the per-workspace alignment and commit automation.
