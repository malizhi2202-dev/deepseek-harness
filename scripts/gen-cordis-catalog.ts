...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  chatBridge: 'channel.md',
  chatChannels: 'channel.md',
  channels: 'channel.md',
  ...
  sources: 'resource-library.md',
  sourcesPanel: 'resource-library.md',
  workspaceAutomation: 'workspace.md',
  workspaceAutomationLedger: 'workspace.md',
  workSummary: 'work-summary.md',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  Agent: 'core.md',
  AutomationLedgerView: 'workspace.md',
  AutomationRunView: 'workspace.md',
  ChannelCredentialView: 'channel.md',
  ChannelProbe: 'channel.md',
  ChannelsStatus: 'channel.md',
  ChannelView: 'channel.md',
  ChatChannelCapabilities: 'channel.md',
  ChatChannelConnector: 'channel.md',
  ChatChannelId: 'channel.md',
  ChatChannelStatus: 'channel.md',
  ChatProbeResult: 'channel.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SourceKind: 'source-kind vocabulary is owned by packages/resource/resource/README.md',
  SourceProvider: 'provider contract is owned by packages/resource/resource/src/types.ts',
  SourcesStatus: 'sources-panel projection is owned by packages/api/sources/src/types.ts',
  SourceProbe: 'sources-panel probe result is owned by packages/api/sources/src/types.ts',
  AlignRequest: 'alignment request is owned by packages/git/git-align/src/types.ts',
  AlignSpec: 'alignment spec is owned by packages/git/git-align/src/types.ts',
  AlignStrategy: 'alignment strategy is owned by packages/git/git-align/src/types.ts',
  ApplyResult: 'alignment apply result is owned by packages/git/git-align/src/types.ts',
  ChangeFactsResult: 'alignment change facts are owned by packages/git/git-align/src/types.ts',
  CommitRequest: 'alignment commit request is owned by packages/git/git-align/src/types.ts',
  CommitResult: 'alignment commit result is owned by packages/git/git-align/src/types.ts',
  FetchResult: 'alignment fetch result is owned by packages/git/git-align/src/types.ts',
  IgnoreResult: 'alignment ignore result is owned by packages/git/git-align/src/types.ts',
  ProbeRequest: 'alignment probe request is owned by packages/git/git-align/src/types.ts',
  ProbeResult: 'alignment probe result is owned by packages/git/git-align/src/types.ts',
  PushedResult: 'alignment remote-published check is owned by packages/git/git-align/src/types.ts',
  RunRecord: 'automation run ledger row is owned by packages/workspace/workspace-automation/src/types.ts',
  RunTrigger: 'automation run trigger is owned by packages/workspace/workspace-automation/src/types.ts',
  WorkspaceAutomationReport: 'automation report is owned by packages/workspace/workspace-automation/src/index.ts',
  WorkSummaryProvider: 'summary provider contract is owned by packages/session/work-summary/src/types.ts',
  WorkSummaryRequest: 'summary request is owned by packages/session/work-summary/src/types.ts',
  WorkSummaryResult: 'summary result is owned by packages/session/work-summary/src/types.ts',
