...
| `packages/client/ui-sidebar-channels` | Client | 新 kind **`channels`**（order 500，`available`）：渠道选择、连接状态、启用开关、配置字段、凭据状态、探测按钮、"为何置灰"提示。 |
...
| `packages/client/ui-sidebar-sources` | Client：新 kind **`sources`**（order 600，`available`） |
